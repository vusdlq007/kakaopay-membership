package com.kakaopay.issuebarcodeapi.api.vo;
...
public class actionLogVo {
    ...
    @JsonBackReference
    @ManyToOne        // 하나의 store는 여러개의 log를 가질수 있기때문에 T_ACT_LOG 관점에서는 @ManyToOne이 된다. 해당 키의 주인되는 엔티티는 외래키를 가지고 있기때문에 현재 테이블인 T_ACT_LOG가 된다.
    @JoinColumn
