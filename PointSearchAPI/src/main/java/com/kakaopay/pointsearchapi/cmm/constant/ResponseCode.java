package com.kakaopay.pointsearchapi.cmm.constant;
...
public enum ResponseCode {
    ...
    HISTORY_SEARCH_FAIL(500,"포인트 조회에 실패하였습니다. 포인트적립 정보가 존재하지 않습니다.","INTER SERVER ERROR"),
    HISTORY_SEARCH_SUCCESS(200,"포인트 조회에 성공하였습니다.","SUCCESS"),
    HISTORY_NO_MEMBER_FAIL(500,"내역 조회에 실패하였습니다. 해당 바코드가 존재하지 않습니다.","INTER SERVER ERROR"),
